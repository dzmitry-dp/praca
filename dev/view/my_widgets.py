...
class AddHoursActions:
    def __init__(self, widget, hours_progress, main_screen) -> None:
        action.logger.info('helper.py: class AddHoursActions __init__()')
        self.widget = widget
        self.hours_progress = hours_progress
        self.main_screen = main_screen

    def add_8_godzin(self, value = 8):
        action.logger.info('helper.py: class AddHoursActions add_8_godzin()')
    ...
    def add_10_godzin(self, value = 10):
        action.logger.info('helper.py: class AddHoursActions add_10_godzin()')
        self.widget.ids.hours_line_data.value = 10
        self.widget.ids.current_hours_value.text = str(int(value))

    def add_12_godzin(self, value = 12):
        action.logger.info('helper.py: class AddHoursActions add_12_godzin()')
        self.widget.ids.hours_line_data.value = 12
        self.widget.ids.current_hours_value.text = str(int(value))

    def add_0_godzin(self, value = 0):
        action.logger.info('helper.py: class AddHoursActions add_0_godzin()')
        self.widget.ids.hours_line_data.value = 0
        self.widget.ids.current_hours_value.text = str(int(value))

    def add_24_godziny(self, value = 24):
        action.logger.info('helper.py: class AddHoursActions add_24_godziny()')
        self.widget.ids.hours_line_data.value = 24
        self.widget.ids.current_hours_value.text = str(int(value))

    def press_ok(self, value):
        action.logger.info('helper.py: class AddHoursActions press_ok()')
    ...
    def set_current_value(self, value):
        action.logger.info('helper.py: class AddHoursActions set_current_value()')
        self.widget.ids.current_hours_value.text = str(int(value))


class ObjectsActions:
    def __init__(self, widget, main_screen) -> None:
        action.logger.info('helper.py: class ObjectsActions __init__()')
        self.widget = widget
        self.main_screen = main_screen

    def _change_obj_btn(self, value):
        action.logger.info('helper.py: class ObjectsActions _change_obj_btn()')
        if value != '':
    ...
    def reaction_on_renoma(self):
        action.logger.info('helper.py: class ObjectsActions reaction_on_renoma()')
    ...
    def reaction_on_zarow(self):
        action.logger.info('helper.py: class ObjectsActions reaction_on_zarow()')
        if self.widget.ids.current_object_value.text != '':
            self.widget.ids.current_object_value.text = ''
    ...
    def reaction_on_redzin(self):
        action.logger.info('helper.py: class ObjectsActions reaction_on_redzin()')
        if self.widget.ids.current_object_value.text != '':
            self.widget.ids.current_object_value.text = ''
    ...
    def press_ok(self):
        action.logger.info('helper.py: class ObjectsActions press_ok()')
        if self.widget.ids.current_object_value.text == '':
...
class WorkObjects(MDBoxLayout):
    ...
    def __init__(self, main_screen, main_screen_logic, *args, **kwargs) -> None:
        ...
        action.logger.info('helper.py: class WorkObjects __init__()')
        self.main_screen = main_screen
...
class AddHoursWidget(MDBoxLayout):
    ...
    def __init__(self, main_screen, main_screen_logic, *args, **kwargs):
        super().__init__(*args, **kwargs)
        action.logger.info('helper.py: class AddHoursWidget __init__()')
        self.main_screen = main_screen
        self.main_screen_logic = main_screen_logic
